...
bgclassifier = BaggingClassifier(estimator=KNeighborsClassifier(n_neighbors=2, p=2, algorithm="brute"), n_estimators=500,
                                 max_features=3,
                                 max_samples=12,
...
display_roc = metrics.RocCurveDisplay(fpr=fpr, tpr=tpr, roc_auc=roc_auc,estimator_name='KNN With FA Feature Extraction')
display_roc.plot()
plt.show()
